...
export function Logomark({
  ...
  return (
    <div className={clsx('flex items-center justify-center rounded-md', invert ? 'bg-white' : 'bg-neutral-950')}>
      <span className={clsx('text-xs font-bold', invert ? 'text-neutral-950' : 'text-white')}>FB</span>
    </div>
  )
}
